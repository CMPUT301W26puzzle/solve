 ...
 *
 * Status model used by invitation actions:
...
public class NotificationRepository {
    ...
    /**
     * Accept invitation:
     * - selectionStatus remains selected
     * - responseStatus becomes accepted
     * - finalStatus becomes enrolled
     */
     ...
     * Decline invitation:
     * - selectionStatus remains selected
     * - responseStatus becomes declined
     * - finalStatus remains null
     * - then draw one replacement from waiting pool
     */
